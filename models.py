...
class MolecularGraphCoupler(nn.Module):
    ...
    def __init__(self,
        ...
        #print(self.ligandEmbedding)
        self.attentive_interaction_pooler = AttentivePooling(chem_hidden_size=output_size,prot_hidden_size=prot_hidden_size)
        self.linear_interaction_pooler = EmbeddingTransform(output_size+prot_hidden_size,128,ap_hidden_size,dropout_p=0.5)

        self.binary_predictor = EmbeddingTransform(ap_hidden_size,32,1,dropout_p=0.5)
    ...
    def forward(self, batch_input, **kwargs):
        ...
        #print(protein_vector[0])
        #print(protein_vector[30])
        #print(protein_vector[45])
        ...
        #print(ligand_vector[0])
        #print(ligand_vector[30])
        #print(ligand_vector[45])
